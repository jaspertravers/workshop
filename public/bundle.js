(function () {
    ...
    const top = typeof global$1 == "undefined" ? window : global$1;
        ...
        return (editor, range) => {
            ...
            if (ranges.length > 1) {
                ...
                if (editor.state.field(snippetState, false) === undefined)
                    spec.reconfigure = { append: [snippetState, snippetKeymap, baseTheme$7] };
            }
...
<button class=${themeClass("button")} type=submit>${view.state.phrase("go")}</button>`;
        ...
        function go() {
            ...
            view.dispatch({
                reconfigure: { append: [baseTheme$8] },
    ...
    ***************************************************************************** */
    ...
    var verbose = typeof browser$1$1 != "undefined" && /\bparse\b/.test(browser$1$1.env.LOG);
